...
namespace Pathfinding
{
	...
	public class PointNode : GraphNode
    {
	    ...
	    ///     <see cref="PointGraph.RegisterConnectionLength" /> with the length of the new connections.
	    /// </summary>
        ...
        public override void AddConnection(GraphNode node, uint cost)
        {
            ...
            (Graph as PointGraph).RegisterConnectionLength((node.position - position).sqrMagnitudeLong);
        }
