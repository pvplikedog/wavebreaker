...
namespace Pathfinding
{
    ...
    public abstract class NavGraph : IGraphInternals
    {
        ...
        ///     Note: This is Pathfinding.Util.Guid not System.Guid. A replacement for System.Guid was coded for better
        ...
        ///     Should be inside UNITY_EDITOR only \<see cref="ifs" /> but just in case anyone tries to serialize a NavGraph
        ///     instance using Unity, I have left it like this as it would otherwise cause a crash when building.
        ...
        ///     For example if you want to move all your nodes in e.g a point graph 10 units along the X axis from the initial
        ///     position
        ///     <code>
        ...
        ///     Can for example tell the function to try to return a walkable node. If you do not get a good
        ///     node back, consider calling GetNearestForce.
        /// </param>
        ...
        ///     Returns: an NNInfo. This method will only return an empty NNInfo if there are no nodes which comply with the
        ...
        ///     This will be called on the same time as OnDisable on the gameObject which the AstarPath script is attached to
        ///     (remember, not in the editor).
        ///     Use for any cleanup code such as cleaning up static variables which otherwise might prevent resources from being
        ///     collected.
        ///     Use by creating a function overriding this one in a graph class, but always call base.OnDestroy () in that
        ///     function.
        ...
        /// <summary>
        ///     Scan the graph.
        ///     Consider using AstarPath.Scan() instead since this function only scans this graph and if you are using multiple
        ///     graphs
        ...
        public virtual void OnDrawGizmos(RetainedGizmos gizmos, bool drawNodes)
        {
            ...
            if (!gizmos.Draw(hasher))
                ...
                {
                    GetNodes(helper.DrawConnections);
                }
    ...
    public class GraphCollision
    {
        ...
        ///     [Open online documentation to see images]
        ///     Warning: In contrast to Unity's capsule collider and character controller this height does not include the end
        ///     spheres of the capsule, but only the cylinder part.
        ...
        /// <summary>
        ///     Make nodes unwalkable when no ground was found with the height raycast. If height raycast is turned off, this
        ...
        ///     The ray will check a tiny bit further than to the grids base to avoid floating point errors when the ground is
        ///     exactly at the base of the grid
        /// </summary>
        public Vector3 CheckHeight(Vector3 position, out RaycastHit hit, out bool walkable)
        {
            ...
            else
            {
                ...
                if (Physics.Raycast(position + up * fromHeight, -up, out hit, fromHeight + 0.005F, heightMask,
                        QueryTriggerInteraction.Ignore)) return hit.point;
        ...
        ///     The returned array may be larger than the actual number of hits, the numHits out parameter indicates how many hits
        ///     there actually were.
        /// </summary>
