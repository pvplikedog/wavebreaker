...
namespace Pathfinding.Util
{
	...
	public class RetainedGizmos
    {
        ...
        {
            if (cachedMeshes.Count > 0) return cachedMeshes.Pop();
        ...
        {
            for (var i = 0; i < meshes.Count; i++) usedHashes.Add(meshes[i].hash);
        }
        ...
        public void FinalizeDraw()
        {
            ...
            if (surfaceMaterial == null)
                surfaceMaterial =
                    AssetDatabase.LoadAssetAtPath(EditorResourceHelper.editorAssets + "/Materials/Navmesh.mat",
                        typeof(Material)) as Material;
            if (lineMaterial == null)
                lineMaterial =
                    AssetDatabase.LoadAssetAtPath(EditorResourceHelper.editorAssets + "/Materials/NavmeshOutline.mat",
                        typeof(Material)) as Material;
#endif
        ...
        public void ClearCache()
        {
            ...
            while (cachedMeshes.Count > 0) Mesh.DestroyImmediate(cachedMeshes.Pop());
        ...
        {
            private readonly List<Color32> lineColors = new();
            ...
            private void SubmitLines(RetainedGizmos gizmos, ulong hash)
            {
                ...
                for (var batch = 0; batch < batches; batch++)
                {
                    ...
                    Assert.IsTrue(lineEndPointCount % 2 == 0);
