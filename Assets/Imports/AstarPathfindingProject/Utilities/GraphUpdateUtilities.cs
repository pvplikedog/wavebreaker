...
namespace Pathfinding
{
	...
	///     This class works a lot with the GraphNode class, a useful function to get nodes is
	...
	public static class GraphUpdateUtilities
    {
	    ...
	    ///     Returns: True if the given nodes are still reachable from each other after the guo has been applied. False
	    ///     otherwise.
	    ///     <code>
	    /// var guo = new GraphUpdateObject(tower.GetComponent<Collider>
	    ///             ().bounds);
	    ...
	    /// <param name="node1">
	    ///     Node which should have a valid path to node2. All nodes should be walkable or false will be
	    ///     returned.
	    /// </param>
	    /// <param name="node2">
	    ///     Node which should have a valid path to node1. All nodes should be walkable or false will be
	    ///     returned.
	    /// </param>
	    ...
	    /// <param name="guo">The GraphUpdateObject to update the graphs with</param>
	    /// <param name="nodes">
	    ///     Nodes which should have valid paths between them. All nodes should be walkable or false will be
	    ///     returned.
	    /// </param>
	    /// <param name="alwaysRevert">If true, reverts the graphs to the old state even if no blocking occurred</param>
