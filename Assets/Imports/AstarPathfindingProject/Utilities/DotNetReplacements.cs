...
namespace Pathfinding.Util
{
	...
	public struct Guid
    {
        ...
        public Guid(byte[] bytes)
        {
            ...
            _a = BitConverter.IsLittleEndian ? a : SwapEndianness(a);
            _b = BitConverter.IsLittleEndian ? b : SwapEndianness(b);
        }
        ...
        public byte[] ToByteArray()
        {
            ...
            var ba = BitConverter.GetBytes(!BitConverter.IsLittleEndian ? SwapEndianness(_a) : _a);
            var bb = BitConverter.GetBytes(!BitConverter.IsLittleEndian ? SwapEndianness(_b) : _b);
