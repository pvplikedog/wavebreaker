...
namespace Pathfinding
{
    internal class PathReturnQueue
    {
	    ...
	    /// </summary>
	    private readonly Queue<Path> pathReturnQueue = new();
        ...
        ///     Do not return all paths at once if it takes a long time, instead return some and wait until the
        ///     next call.
        /// </param>
        public void ReturnPaths(bool timeSlice)
        {
            ...
            while (true)
            {
                ...
                {
                    counter = 0;
                    if (DateTime.UtcNow.Ticks >= targetTick) break;
                }
            }
