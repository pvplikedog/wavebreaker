...
namespace Pathfinding
{
	...
	///     The link corresponding to one of those intermediate nodes can be retrieved using the <see cref="GetNodeLink" />
	///     method
    ...
    public class NodeLink2 : GraphModifier
    {
        ...
        ///     Note that values lower than 1 will not always make the pathfinder choose this path instead of another path even
        ...
        public void OnDrawGizmos(bool selected)
        {
            ...
            if (StartTransform != null) Draw.Gizmos.CircleXZ(StartTransform.position, 0.4f, color);
            if (EndTransform != null) Draw.Gizmos.CircleXZ(EndTransform.position, 0.4f, color);
