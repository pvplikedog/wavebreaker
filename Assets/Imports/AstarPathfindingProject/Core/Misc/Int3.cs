...
namespace Pathfinding
{
    ...
    public struct Int3 : IEquatable<Int3>
    {
        ...
        ///     One world unit is divided into [value] pieces. A value of 1000 would mean millimeter precision, a value of 1 would
        ///     mean meter precision (assuming 1 world unit = 1 meter).
        ///     This value affects the maximum coordinates for nodes as well as how large the cost values are for moving between
        ///     two nodes.
        ///     A higher value means that you also have to set all penalty values to a higher value to compensate since the normal
        ///     cost of moving will be higher.
        /// </summary>
        ...
        {
            var cos = Dot(lhs, rhs) / (lhs.magnitude * (double)rhs.magnitude);
        ...
        /// <summary>
        ///     Returns the magnitude of the vector. The magnitude is the 'length' of the vector from 0,0,0 to this point. Can be
    ...
    public struct Int2 : IEquatable<Int2>
    {
        ...
        public long sqrMagnitudeLong => x * (long)x + y * (long)y;
