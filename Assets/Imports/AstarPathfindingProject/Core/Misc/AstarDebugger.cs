...
namespace Pathfinding
{
    ...
    public class AstarDebugger : VersionedMonoBehaviour
    {
        ...
        private readonly PathTypeDebug[] debugTypes =
        {
        ...
        private readonly int fpsDropCounterSize = 200;
        private float[] fpsDrops;

        private GraphPoint[] graph;
        private readonly float graphHeight = 100;
        private readonly float graphOffset = 50;
        ...
        public void LateUpdate()
        {
            ...
            if (Application.isPlaying && cam != null && showGraph)
            {
                ...
                var m = Matrix4x4.TRS(new Vector3((cam.pixelWidth - graphWidth) / 2f, graphOffset, 1),
        ...
        public void OnGUI()
        {
            ...
            if (Time.realtimeSinceStartup - lastUpdate > 0.5f || cachedText == null || !Application.isPlaying)
            {
                ...
                text.Append("A* Version: ").Append(AstarPath.Version);
 ...
 (double)AstarPath.TotalSearchedNodes*10000 / (double)AstarPath.TotalSearchTime;
                        ...
                        for (var i = 0; i < debugTypes.Length; i++) debugTypes[i].Print(text);
                    }
                }
        ...
        private struct PathTypeDebug
        {
            ...
            private readonly Func<int> getSize;
            private readonly Func<int> getTotalCreated;
