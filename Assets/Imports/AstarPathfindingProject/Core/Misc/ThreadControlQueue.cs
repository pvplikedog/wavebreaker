...
namespace Pathfinding
{
    ...
    internal class ThreadControlQueue
    {
        ...
        private readonly ManualResetEvent block = new(true);
        ...
        ///     Properties like AllReceiversBlocked rely on knowing the exact number of receivers using the Pop (or PopNoBlock)
        ///     methods.
        /// </summary>
        ...
        public Path Pop()
        {
                ...
                while (blocked || starving)
                {
                    ...
                    if (blockedReceivers > numReceivers)
                        throw new InvalidOperationException(
                            "More receivers are blocked than specified in constructor (" + blockedReceivers + " > " +
                            numReceivers + ")");
            ...
            finally
            {
                ...
                if (Monitor.IsEntered(lockObj)) Monitor.Exit(lockObj);
            }
        }
        ...
        public Path PopNoBlock(bool blockedBefore)
        {
            ...
            try
            {
                ...
                if (blockedBefore) blockedReceivers--;
