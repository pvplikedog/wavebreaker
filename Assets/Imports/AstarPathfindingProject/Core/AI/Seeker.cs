...
namespace Pathfinding
{
	...
	///     \ingroup relevant
	///     This is a component which is meant to be attached to a single unit (AI, Robot, Player, whatever) to handle its
	///     pathfinding calls.
    ...
    public class Seeker : VersionedMonoBehaviour
    {
        ...
        ///     It is useful in numerous situations, for example if you want to make one graph for small units and one graph for
        ///     large units.
        ...
        ///     See: bitmasks (view in online documentation for working links)
        ///     Note that this field only stores which graph indices that are allowed. This means that if the graphs change their
        ///     ordering
        ...
        /// </code>
        ///     Some overloads of the <see cref="StartPath" /> methods take a graphMask parameter. If those overloads are used then
        ///     they
        ...
        private readonly List<IPathModifier> modifiers = new();
        ...
        [NonSerialized] private List<GraphNode> lastCompletedNodePath;

        /// <summary>Used for drawing gizmos</summary>
        [NonSerialized] private List<Vector3> lastCompletedVectorPath;

        /// <summary>The path ID of the last path queried</summary>
        protected uint lastPathID;

        /// <summary>The current path</summary>
        [NonSerialized] protected Path path;
        ...
        [NonSerialized] private Path prevPath;
        ...
        ///     This should have been implemented as optional parameter values, but that didn't seem to work very well with
        ///     delegates (the values weren't the default ones)
