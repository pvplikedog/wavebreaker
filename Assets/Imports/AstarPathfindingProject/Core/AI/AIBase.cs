...
namespace Pathfinding
{
    ...
    public abstract class AIBase : VersionedMonoBehaviour
    {
        ...
        [FormerlySerializedAs("speed")] public float maxSpeed = 1;
        ...
        ///     See: Combined with calling <see cref="MovementUpdate" /> from a separate script instead of it being called
        ///     automatically one can take a similar approach to what is documented here:
        ...
        ///     A green gizmo line will be drawn upwards from the pivot point of the character to indicate where the raycast will
        ///     start.
        ///     See: <see cref="gravity" />
        ...
        ///     in a zombie game.
        ///     Deprecated: In 4.1 this will automatically add a <see cref="Pathfinding.AIDestinationSetter" /> component and set
        ...
        public Vector3 velocity =>
            lastDeltaTime > 0.000001f ? (prevPosition1 - prevPosition2) / lastDeltaTime : Vector3.zero;

        /// <summary>
        ///     Velocity that this agent wants to move with.
        ///     Includes gravity and local avoidance if applicable.
        /// </summary>
        public Vector3 desiredVelocity => lastDeltaTime > 0.00001f
        ...
        protected virtual bool shouldRecalculatePath =>
            !waitingForPathCalculation && autoRepath.ShouldRecalculatePath((IAstarAI)this);
        ...
        ///     This is done during <see cref="OnEnable" />. If you are adding/removing components during runtime you may want to
        ///     call this function
        ///     to make sure that this script finds them. It is unfortunately prohibitive from a performance standpoint to look for
        ...
        ///     Useful when you are handling movement externally using <see cref="FinalizeMovement" /> but you want to use the
        ///     built-in rotation code.
        ///     See: <see cref="orientation" />
        /// </summary>
        ...
        protected Quaternion SimulateRotationTowards(Vector2 direction, float maxDegrees)
        {
            ...
            {
                var targetRotation = Quaternion.LookRotation(movementPlane.ToWorld(direction),
        ...
        ///     are available.
        ///     The agent will be clamped to the navmesh after the movement (if such information is available, generally this is
        ///     only done by the RichAI component).
        ...
        /// <param name="lastElevation">
        ///     Elevation coordinate before the agent was moved. This is along the 'up' axis of the
        ///     #movementPlane.
        /// </param>
        protected Vector3 RaycastPosition(Vector3 position, float lastElevation)
        {
                    ...
                    QueryTriggerInteraction.Ignore))
            {
                ...
                verticalVelocity *= Math.Max(0, 1 - 5 * lastDeltaTime);
                return hit.point;
            }
