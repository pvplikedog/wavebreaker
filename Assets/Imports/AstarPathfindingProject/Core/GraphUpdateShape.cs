...
namespace Pathfinding
{
	...
	///     The shape consists of a number of points which it can either calculate the convex hull of or use as a polygon
	///     directly.
	...
	public class GraphUpdateShape
    {
        ...
        /// </summary>
        /// <param name="points">
        ///     Contour of the shape in local space with respect to the matrix (i.e the shape should be in the XZ
        ///     plane, the Y coordinate will only affect the bounds)
        /// </param>
        ...
        ///     If the points would be in the XZ plane only, the shape would not have a height and then it might not
        ...
        public bool convex
        {
            ...
            set
            {
                if (_convex != value && value) CalculateConvexHull();
                _convex = value;
            }
        }
        ...
        private static Bounds GetBounds(Vector3[] points, Vector3 right, Vector3 up, Vector3 forward, Vector3 origin,
            float minimumHeight)
        {
