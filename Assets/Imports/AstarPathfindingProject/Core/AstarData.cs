...
namespace Pathfinding
{
    ...
    public class AstarData
    {
	    ...
	    /// </summary>
	    [NonSerialized] public NavGraph[] graphs = new NavGraph[0];

        //Serialization Settings

        /// <summary>
        ///     Serialized data for all graphs and settings.
        ///     Stored as a base64 encoded string because otherwise Unity's Undo system would sometimes corrupt the byte data
        ///     (because it only stores deltas).
        ...
        private byte[] data
        {
            ...
            set => dataString = value != null ? Convert.ToBase64String(value) : null;
        }
        ...
        ///     Caching the startup means saving the whole graphs - not only the settings - to a file (
        ///     <see cref="file_cachedStartup)" /> which can
        ///     be loaded when the game starts. This is usually much faster than scanning the graphs when the game starts. This is
        ///     configured from the editor under the "Save & Load" tab.
        ...
        private List<bool> graphStructureLocked = new();
        ...
        ///     This is used when e.g an async scan is happening to ensure that for example a graph that is being scanned is not
        ///     destroyed.
        ...
        {
            if (graphStructureLocked.Count == 0) throw new InvalidOperationException();
        ...
        {
            if (data != null) DeserializeGraphs(data);
        }
        ...
        /// <summary>
        ///     Returns: A System.Type which matches the specified type string. If no mathing graph type was found, null is
        ///     returned
        ///     Deprecated:
        /// </summary>
        ...
        /// <summary>
        ///     Creates a new instance of a graph of type type. If no matching graph type was found, an error is logged and null is
        ///     returned
        ...
        private void AddGraph(NavGraph graph)
        {
            ...
            if (!foundEmpty)
            {
                if (graphs != null && graphs.Length >= GraphNode.MaxGraphIndex)
                    throw new Exception("Graph Count Limit Reached. You cannot have more than " +
        ...
        ///     Returns: True if the graph was sucessfully removed (i.e it did exist in the <see cref="graphs" /> array). False
        ///     otherwise.
        ...
        public bool RemoveGraph(NavGraph graph)
        {
            ...
            var i = Array.IndexOf(graphs, graph);
        ...
        public static NavGraph GetGraph(GraphNode node)
        {
            ...
            if (graphIndex >= data.graphs.Length) return null;
        ...
        /// <summary>
        ///     Returns the first graph of type type found in the <see cref="graphs" /> array. Returns null if no graph was
        ///     found.
        /// </summary>
        public NavGraph FindGraphOfType(Type type)
        {
            return FindGraph(graph => Equals(graph.GetType(), type));
        }
        ...
        ///     Deprecated: Deprecated because it is not used by the package internally and the use cases are few. Iterate through
        ///     the <see cref="graphs" /> array instead.
        /// </summary>
        [Obsolete(
        ...
        public int GetGraphIndex(NavGraph graph)
        {
            ...
            if (graphs != null)
            {
                index = Array.IndexOf(graphs, graph);
