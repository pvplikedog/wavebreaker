...
namespace Pathfinding
{
	...
	public class PathNode
    {
        ...
        private const uint Flag1Mask = 1 << Flag1Offset;

        /// <summary>Flag 2 is at bit 29</summary>
        private const int Flag2Offset = 29;

        private const uint Flag2Mask = 1 << Flag2Offset;
    ...
    public class PathHandler
    {
	    ...
	    /// </summary>
	    public readonly StringBuilder DebugStringBuilder = new();
        ...
        public void InitializeNode(GraphNode node)
        {
            ...
            if (ind >= nodes.Length)
            {
                ...
                var newNodes = new PathNode[Math.Max(128, nodes.Length * 2)];
